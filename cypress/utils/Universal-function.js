...
export function TabPaymentlink() { // เปิด Paymentlink
   // cy.get('.wrap-sidenav-desktop >:nth-child(2)').trigger('mouseover')
    cy.get('.wrap-sidenav-desktop >:nth-child(2)').realHover()
    cy.get('.wrap-sidenav-desktop >:nth-child(2)').click()
  }
